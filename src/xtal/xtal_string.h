...
public:
	...
	*/
	String(const char* str, uint_t size, long_lived_t){
...
private:
	void init_string(const char* str, uint_t size);
	void init_long_lived_string(const char* str, uint_t size);
	void init_small_string(const char* str, uint_t size);
...
IDPtr intern(const char* str, String::long_lived_t);
...
public:
	...
	*
	*/
	ID(const char* str, uint_t size, String::long_lived_t)
...
public:
	...
	ID(const char* str, uint_t size, intern_t)
		:String(noinit_t()){
	...
	ID(const char* str, uint_t size, small_intern_t)
		:String(noinit_t()){
