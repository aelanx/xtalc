...
public:
	...
	struct Node{
		...
		void set_pointer(char* str){ *(char**)XTAL_STRUCT_TAIL(this) = str; }
		char* pointer(){ return *(char**)XTAL_STRUCT_TAIL(this); }
		char* buf(){ return (char*)XTAL_STRUCT_TAIL(this); }
		char* data() const{ return flags ? *(char**)XTAL_STRUCT_TAIL(this) : (char*)XTAL_STRUCT_TAIL(this); }
	};
...
public:
	...
	const char* register_string(const char* str, uint_t size, uint_t hashcode, bool long_lived);
