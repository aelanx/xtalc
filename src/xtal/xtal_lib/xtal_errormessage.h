...
inline void bind_error_message(){
	const char* messages[] = {
		XTAL_L("XCE1001"), XTAL_L("CompileError: Invalid Syntax"),
		XTAL_L("XCE1002"), XTAL_L("CompileError: Expected '%(required)s', got '%(char)s'"),
		...
		XTAL_L("XCE1019"), XTAL_L("CompileError:'%(name)' is impossible assignment."),
		...
		XTAL_L("XCE1028"), XTAL_L("CompileError:The front and rear of the priorities of the blank and operators of the operator does not match. There is a possibility that is different from the priority is assumed."),
		XTAL_L("XCE1029"), XTAL_L("XCE1029:a&1というように、bitwise andを条件式とすることは安全のため禁止されています。(a&1)!=0という形で比較してください。"),
		XTAL_L("XCE1030"), XTAL_L("XCE1012:不正な定義文の左辺です。"),
		
		XTAL_L("XRE1001"), XTAL_L("XRE1001:'%(object)s' 関数呼び出しの '%(no)s'番目の引数の型が不正です。'%(required)s'型を要求していますが、'%(type)s'型の値が渡されました。"),
		XTAL_L("XRE1002"), XTAL_L("RuntimeError: During the compilation of the source, compile error has occurred."),
		...
		XTAL_L("XRE1016"), XTAL_L("RuntimeError: An error occurred while compiling '%(name)s'"),
		...
		XTAL_L("XRE1021"), XTAL_L("RuntimeError: %(object)s is not defined. Did you mean '%(pick)s'?"),
		...
		XTAL_L("XRE1029"), XTAL_L("XRE1029:Defined class '%(name)' in C++, can be inherited only when the class generation."),
		XTAL_L("XRE1030"), XTAL_L("XRE1030:暗黙の変数参照があります。%(name)s"),
		XTAL_L("XRE1031"), XTAL_L("XRE1031:シングルトンクラスはシングルトンクラスでないと継承できません。"),
		XTAL_L("XRE1032"), XTAL_L("RuntimeError: Could not open '%(name)s'"),
		XTAL_L("XRE1033"), XTAL_L("XRE1033:ストリームの終端以降を読み取ろうとしました。"),
		XTAL_L("XRE1034"), XTAL_L("RuntimeError: Infinite loop An attempt was made to perform an xpeg element that can occur"),
