...
public:
	...
	*/
	void def(const char* primary_key, const AnyPtr& value, const AnyPtr& secondary_key, int_t accessibility = KIND_DEFAULT);
	...
	* \param value 設定する値
	*/
	void def(const char* primary_key, const AnyPtr& value);
