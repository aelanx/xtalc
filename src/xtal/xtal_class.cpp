...
void Class::def(const char* primary_key, const AnyPtr& value, const AnyPtr& secondary_key, int_t accessibility){
...
void Class::def(const char* primary_key, const AnyPtr& value){
