...
/**
* \internal
* \brief Retrieve the value from the value table
*
*/
XTAL_DEF_INST_2(2, InstLoadConstant,
	i8, result, // Local variable number to assign a value
    u16, value_number // Table number to retrieve the value
);

/**
* \internal
* \brief To push an int value to a local variable.
*
*/
...
XTAL_DEF_INST_7(54, InstSend,
	i8, result,  // Local variable number to assign a value
    u8, need_result,
	i8, target, // Local variable number to retrieve the value
	i16, primary,
	i8, secondary,
	i8, stack_base,
    u8, ordered
